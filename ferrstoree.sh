...
check_token() {
  echo -e "                                                       "
  echo -e "${BLUE}[+] =============================================== [+]${NC}"
  echo -e "${BLUE}[+]               LICENSY BY FERRSTOREE            [+]${NC}"
  echo -e "${BLUE}[+] =============================================== [+]${NC}"
  echo -e "                                                       "
  echo -e "${YELLOW}MASUKAN AKSES TOKEN :${NC}"
  read -r USER_TOKEN

  if [ "$USER_TOKEN" = "ferrskyxyz" ]; then
    echo -e "${GREEN}AKSES BERHASIL${NC}}"
  else
    echo -e "${GREEN}Buy Token Di FerrStoree${NC}"
    echo -e "${YELLOW}TELEGRAM : @ferrd_10${NC}"
    echo -e "${YELLOW}WHATSAPP : 6288214173300${NC}"
    echo -e "${YELLOW}HARGA TOKEN : 5K FREE UPDATE JIKA ADA TOKEN BARU${NC}"
    echo -e "${YELLOW}©ferrskyxyz${NC}"
    exit 1
  fi
  clear
}
...
while true; do
  ...
  echo -e "${BLUE}'ggg      ,gg'''  .    ggg       Auto Installer FerrStoree   ${NC}"
  echo -e "${BLUE}gggg      gg     ,     ggg      ------------------------  ${NC}"
  echo -e "${BLUE}ggg:     gg.     -   ,ggg       • Telegram : t.me/ferrd_10    ${NC}"
  echo -e "${BLUE} ggg:     ggg._    _,ggg        • Whatsapp : 0896-0342-9352  ${NC}"
  echo -e "${BLUE} ggg.    '.'''ggggggp           • Ghitub : @ferrskyxyz  ${NC}"
